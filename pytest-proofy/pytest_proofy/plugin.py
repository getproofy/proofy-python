...
from .config import ProofyConfig, register_options, resolve_options, setup_pytest_ini_options
...
def pytest_runtest_setup(item: pytest.Item) -> None:
    ...
    if _plugin_instance.config.mode == "live" and _plugin_instance.client and _plugin_instance.run_id:
        try:
            result = TestResult(
                id=test_id,
